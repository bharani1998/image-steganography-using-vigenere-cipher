...
<h1>LSB MESSAGE ENCODING USING VEGENERE CIPHER</h1>
...
<tr>
  ...
  <td>
    <center>
<br><br>
    <input type='submit' value='Save image' name='but_upload'style="font-size : 20px; width: 60%; height: 50px;">
<input type="submit" name="submit" value="Encode Message"  style="font-size : 20px; width: 60%; height: 50px;">
</center>
